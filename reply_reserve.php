	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>HACER UNA RESERVA</h3></strong>
				<br />
				<div class = "col-md-4"></div>
				<div class = "well col-md-4">
					<center><h3>Visita nuestro Hotel para verificar</h3></center>
					<br />
					<center><h4>GRACIAS!</h4></center>
					<br />
					<center><a href = "reservation.php" class = "btn btn-success"><i class = "glphyicon glyphicon-check"></i> Volver a la reserva</a></center>
				</div>
				<div class = "col-md-4"></div>
			</div>
		</div>
