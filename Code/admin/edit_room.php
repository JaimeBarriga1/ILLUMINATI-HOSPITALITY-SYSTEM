...
<body>
	...
	<div class = "container-fluid">	
		...
		<li class = "active"><a href = "account.php">Cuentas</a></li>
			...
			<li><a href = "room.php">Habitación</a></li>	
			<li><a href =></a></li>				
		</ul>	
	</div>
	<br />
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Transacción / Habitación / Cambiar habitación</div>
				<br />
				<div class = "col-md-4">
					<?php
					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Executive Suite" <?php if($fetch['room_type'] == "Executive Suite"){echo "selected";}?>>Suite ejecutiva</option>
							</select>
						</div>
						<div class = "form-group">
							<label>Precio </label>
						...
						<br />
						<div class = "form-group">
							<button name = "edit_room" class = "btn btn-warning form-control"><i class = "glyphicon glyphicon-edit"></i> Guardar cambios</button>
						</div>
					</form>
